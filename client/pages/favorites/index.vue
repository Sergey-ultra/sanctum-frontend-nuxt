        ...
        <div class="favorites">
            ...
            <div  v-else>
                ...
                >
                    ...
                    >
                        <img :src="`${$config.APP_URL}/${sku.image}`" :alt="sku.name"/>
                    </nuxt-link>
...
<script setup>
    ...
    watch($api.isAuth, () => favoritesStore.loadFavoriteSkus());

    onMounted(() => favoritesStore.loadFavoriteSkus());
</script>
